...
public class RSI implements Indicator {
    ...
    public int prosperityLevel(List<EasyMoneyStockDayInfoDTO> stockdayinfoList) {
    ...
    public List<EasyMoneyStockDayInfoDTO> getDayIndicatorList(List<EasyMoneyStockDayInfoDTO> stockdayinfoList) {
        ...
        for (int i = 0; i < stockDayInfoListSize; i++) {
            EasyMoneyStockDayInfoDTO stockDayInfo = stockdayinfoList.get(i);
            if (i == 0) {
    ...
    public List<EasyMoneyStockWeekInfoDTO> getWeekIndicatorList(List<EasyMoneyStockWeekInfoDTO> stockweekinfoList) {
        ...
        for (int i = 0; i < stockWeekInfoListSize; i++) {
            EasyMoneyStockWeekInfoDTO stockWeekInfo = stockweekinfoList.get(i);
            if (i == 0) {
    ...
    public List<EasyMoneyStockMonthInfoDTO> getMonthIndicatorList(List<EasyMoneyStockMonthInfoDTO> stockmonthinfoList) {
        ...
        for (int i = 0; i < stockMonthInfoListSize; i++) {
            EasyMoneyStockMonthInfoDTO stockMonthInfo = stockmonthinfoList.get(i);
            if (i == 0) {
